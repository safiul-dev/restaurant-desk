      ...
      Cell: (row: any) => {
        return (
          <div className=" ">
            ...
            <span className=" px-2 py-0 bg-emerald-200 text-emerald-700 rounded-full">active</span> 
            : 
            <span className=" px-2 py-0 bg-red-200 text-red-700 rounded-full">deactive</span>
            }
          </div>
        );
      },
