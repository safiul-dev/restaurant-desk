              ...
              <div className="w-full h-height35% bg-secondary mb-2 rounded-md flex justify-center items-center">
                  <div className="w-full  overflow-y-auto flex 2xl:px-4 2xl:py-4 xl:px-4 xl:py-4 lg:px-3 lg:py-3 md:px-2 md:my-2 sm:px-1 sm:py-1">
                     <div className="w-width50% h-full text-right mr-2">
                        ...
                        <h1 className="text-white uppercase rounded bg-TheadColor mb-1 pr-2 2xl:font-bold xl:font-semibold lg:font-medium md:font-normal sm:font-light 2xl:text-lg xl:text-base lg:text-tiny md:text-smallFont sm:text-smallFont">Pain Amount:</h1>
                     ...
                     <div className="w-width50% h-full">
                        <input type="text" value="1200.00" className="w-full rounded text-black text-center mb-1 2xl:font-bold xl:font-semibold lg:font-medium md:font-normal sm:font-light 2xl:text-lg xl:text-lg lg:text-base md:text-smallFont sm:text-smallFont" />
              ...
              <div className="w-full h-height64% bg-secondary rounded-md ">
                  <div className="w-full h-full 2xl:px-4 2xl:py-4 xl:px-4 xl:py-4 lg:px-3 lg:py-3 md:px-2 md:my-2 sm:px-1 sm:py-1">
                     ...
                     <div className=" w-full h-height25% flex">
                                 <button className=" bg-blue rounded-bl-md text-center w-width20% h-full border border-black text-white">
                                 ...
                                 <button className=" bg-blue w-width20% text-center h-full border border-black text-white">
                                 ...
                                 <button className=" bg-blue w-width20% h-full border border-black text-white">
                                 ...
                                 <button className=" bg-blue rounded-br-md w-width20% h-full border border-black text-white">
