...
class Index extends Component<P, IndexState> {
    ...
    async saveModal () {
        ...
        if(this.state.table) { 
            ...
            const categoryUniq = this.state.categoryUniq === ''? CategoryDatas.data[0].uniq : this.state.categoryUniq
            await ItemDatas.addItem(uniq,"user1", this.state.title, this.state.description,categoryUniq, this.state.price, this.state.active)
            this.setState({ 
                title: '',
                description: '',
                categoryUniq: '',
    ...
    cancelModal () {
        this.setState({
            modal: false,
            categoryUniq: CategoryDatas.data[0].uniq
                                ...
                                <div className="flex justify-between py-1 px-1">
                                    ...
                                    { 
                                      this.state.table?
                                        ...
                                        :
                                        <div onClick={() => this.setState({table: true, moduleName: "Add Item",categoryUniq: CategoryDatas.data[0].uniq})} className="outline-none cursor-pointer">
                                            <div className="">
