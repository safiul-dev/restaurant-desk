...
const Index = observer(() =>{
    ...
    function saveModal() {
        ...
        CustomerDatas.addCustomer(name, email, phone, address, active)
    ...
    useEffect(() => {CustomerDatas.getCustomers()})
        return (
            <React.Fragment>
            <AppLayout>
                    ...
                    <div className="w-width94% bg-white h-full">
                        <div className="w-width70% h-full mx-auto 2xl:mt-6 xl:mt-5 lg:mt-4 md:mt-3 sm:mt-2">
                            <div className="h-height9% w-full flex justify-center items-center 2xl:mb-6 xl:mb-5 lg:mb-4 md:mb-3 sm:mb-2">
                                ...
                                <h1 className=" text-white 2xl:font-black xl:font-extrabold lg:font-bold md:font-semibold sm:font-medium 2xl:text-4xl xl:text-xl lg:text-lg md:text-base sm:text-tiny uppercase">Customas</h1>
                                </div>
                                <svg className="h-full" viewBox="0 0 45 80" fill="none" xmlns="http://www.w3.org/2000/svg">
