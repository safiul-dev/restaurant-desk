...
function Index() {
  ...
  const clickToShow = () => {
    ...
    setItem(getPayment?<Payment/>:<CategoryRightbar1/>)
  }
  return (
    <React.Fragment>
    <AppLayout>
